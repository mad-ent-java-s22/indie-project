...
{__        {__  {__    {__   {_   {__  {__    Date: 4/8/2022, 2:03 PM
...
<html>
<head>
  <title>Comment Added | Otter</title>
    ...
    <main class="container">
      <div class="p-4 p-md-5 mb-4 text-white rounded bg-success">
        <div class="col-md-12 px-0">
          <h1 class="display-4 w-100">Your comment has been added!</h1>
          <p class="lead my-3 fst-italic">Thank you for your contribution.</p>
          <p class="lead mb-0"><a href="<%=request.getContextPath()%>/posts/${postId}" class="btn btn-dark">Return to Post</a></p>
        </div>
      </div>
    </main>
