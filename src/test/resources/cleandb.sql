...
INSERT INTO `blog`.`user` (`user_name`, `first_name`, `last_name`, `email`, `password`, `profile_image`, `summary`) VALUES ('user1', 'Pam', 'Smith', 'pam@gmail.com', 'password', 'generated_photo_1.jpg', 'Pam is a journalist at Otter');
INSERT INTO `blog`.`user` (`user_name`, `first_name`, `last_name`, `email`, `password`, `profile_image`, `summary`) VALUES ('user2', 'David', 'Johnson', 'dave@gmail.com', 'password', 'generated_photo_2.jpg', 'David is the Los Angeles correspondent at Otter. He began his career covering the 2004 elections and later worked in the White House during the Obama Administration.');
INSERT INTO `blog`.`user` (`user_name`, `first_name`, `last_name`, `email`, `password`, `profile_image`, `summary`) VALUES ('user3', 'Gina', 'Lucas', 'gina@gmail.com', 'password', 'generated_photo_3.jpg', 'Gina is a journalist at Otter');
INSERT INTO `blog`.`user` (`user_name`, `first_name`, `last_name`, `email`, `password`, `profile_image`, `summary`) VALUES ('user4', 'Tony', 'Davis', 'tony@gmail.com', 'password', 'generated_photo_4.jpg', 'Tony is a journalist at Otter');
