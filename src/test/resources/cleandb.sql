...
INSERT INTO `blog`.`user` (`user_name`, `first_name`, `last_name`, `email`, `password`, `profile_image`, `summary`) VALUES ('user2', 'David', 'Johnson', 'dave@gmail.com', 'password', 'generated_photo_2.jpg', 'David is the Los Angeles correspondent at Spry. He began his career covering the 2004 elections and later worked in the White House during the Obama Administration.');
