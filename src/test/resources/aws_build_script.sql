...
INSERT INTO `blog`.`post` (`title`, `content`, `user_id`, `summary`) VALUES ('Ethical Design in Social Media',
                                                                             ...
                                                                             <h2>Choice Architecture: From Buffet Tables to Ethical Design in Social Media</h2>
                                                                             ...
                                                                             <blockquote class="blockquote bg-light p-2"><p>There is no such thing as a “neutral” design.</p><footer class="blockquote-footer">Thaler and Sunstein</footer></blockquote>
